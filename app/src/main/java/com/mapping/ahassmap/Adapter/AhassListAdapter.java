...
public class AhassListAdapter extends ArrayAdapter<Ahass> {
    ...
    public AhassListAdapter(@NonNull Context context, int resource, @NonNull ArrayList<Ahass> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView tvStreet = (TextView) convertView.findViewById(R.id.tvStreetName);

        tvName.setText(Nama);
        tvStreet.setText(Alamat);
